package com.adhibuchori.storyapp.ui.auth.signup
...
import com.adhibuchori.storyapp.databinding.ActivitySignupBinding
...
class SignupActivity : AppCompatActivity() {
    ...
    private fun playAnimation() {
        ...
        val etlName = ObjectAnimator.ofFloat(binding.nameEditTextLayout, View.ALPHA, 1f).setDuration(1000)
