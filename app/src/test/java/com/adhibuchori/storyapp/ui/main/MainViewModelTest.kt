...
import com.adhibuchori.storyapp.DataDummy
import com.adhibuchori.storyapp.MainDispatcherRule
...
import com.adhibuchori.storyapp.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val differ = AsyncPagingDataDiffer(
            diffCallback = ItemUserStoryAdapter.DIFF_CALLBACK,
